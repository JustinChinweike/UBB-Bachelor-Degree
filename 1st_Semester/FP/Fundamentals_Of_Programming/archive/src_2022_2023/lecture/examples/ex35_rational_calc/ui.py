from archive.src_2022_2023.lecture.examples.ex35_rational_calc.calculator import Calculator
from archive.src_2022_2023.lecture.examples.ex35_rational_calc.domain import Rational
