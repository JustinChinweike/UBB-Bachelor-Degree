...
from library.src.tic_tac_toe.logic.exceptions import InvalidMove, UnknownGameScore
from library.src.tic_tac_toe.logic.validators import validate_game_state, validate_grid
...
# 8 winning patterns, 3 Horizontal lines,
# 3 vertical lines and 2 diagonal lines.
