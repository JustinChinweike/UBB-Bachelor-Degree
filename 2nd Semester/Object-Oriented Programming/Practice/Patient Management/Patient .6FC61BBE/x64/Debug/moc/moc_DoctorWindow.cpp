...
constexpr auto qt_meta_stringdata_CLASSDoctorWindowENDCLASS = QtMocHelpers::stringData(
    "DoctorWindow",
    "onCheckboxToggled",
    "",
    "checked",
...
void DoctorWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onCheckboxToggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->onAddPatient(); break;
        case 2: _t->onUpdatePatient(); break;
        default: ;
        }
    }
}
