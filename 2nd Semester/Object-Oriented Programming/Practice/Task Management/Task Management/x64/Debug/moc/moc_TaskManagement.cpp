...
struct qt_meta_stringdata_CLASSTaskManagementENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTaskManagementENDCLASS = QtMocHelpers::stringData(
    "TaskManagement"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTaskManagementENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TaskManagement::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTaskManagementENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTaskManagementENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTaskManagementENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TaskManagement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTaskManagementENDCLASS.stringdata0))
