...
struct qt_meta_stringdata_CLASSProgrammerWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSProgrammerWindowENDCLASS = QtMocHelpers::stringData(
    "ProgrammerWindow",
    "addTask",
    "",
    "removeTask",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSProgrammerWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ProgrammerWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSProgrammerWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSProgrammerWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSProgrammerWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<ProgrammerWindow, std::true_type>,
        // method 'addTask'
...
void ProgrammerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->doneTask(); break;
        case 4: _t->populateTaskList(); break;
        default: ;
        }
    }
    (void)_a;
...
void *ProgrammerWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSProgrammerWindowENDCLASS.stringdata0))
