...
void initController(MedicineDynamicArray* repository)
{
	...
	addMedicineController(repository, undoArray, redoArray, getNextId(), "IdontKnow: ", 70, 15, 30);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Aspirinol: ", 21, 3, 90);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Nurofen: ", 10, 4, 21);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Feveron: ", 76, 49, 81);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Brufen: ", 23, 17, 33);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Zithromax: ", 48, 57, 69);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Cipro: ", 19, 4, 21);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Flagyl: ", 70, 92, 84);
	addMedicineController(repository, undoArray, redoArray, getNextId(), "Avelox: ", 30, 15, 35);
