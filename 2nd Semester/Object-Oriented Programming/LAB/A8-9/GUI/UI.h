...
public:
    ...
    // Function to save the shopping basket to a file
    void saveShoppingBasketToFile(const std::vector<TrenchCoat>& shoppingBasket);


    void saveShoppingBasketToCSV(const std::vector<TrenchCoat>& shoppingBasket);

    void saveShoppingBasketToHTML(const std::vector<TrenchCoat>& shoppingBasket);
