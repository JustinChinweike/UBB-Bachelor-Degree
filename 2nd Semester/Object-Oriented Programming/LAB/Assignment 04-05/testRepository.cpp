...
void testAddTrenchCoat()
{
    ...
    // Add an initial trench coat to the repository
    repository.addTrenchCoat(1, 2, "initial", 10, 1, "initial_link");

    // Test adding a new trench coat
    repository.addTrenchCoat(2, 3, "red", 20, 2, "red_link");
    assert(repository.getSize() == 2);

    // Test adding another trench coat
    repository.addTrenchCoat(3, 4, "blue", 30, 3, "blue_link");
