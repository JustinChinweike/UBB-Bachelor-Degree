...
void AdminWindow::setupUI() {
    ...
    connect(undoButton, &QPushButton::clicked, this, &AdminWindow::undo);
    connect(redoButton, &QPushButton::clicked, this, &AdminWindow::redo);
...
void AdminWindow::populateTable() {
    ...
    model = new TrenchCoatTableModel(trenchCoats, this);
