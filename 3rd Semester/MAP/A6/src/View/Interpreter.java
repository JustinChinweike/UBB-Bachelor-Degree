...
public class Interpreter {
    public static void main(String[] args) {
        IStatement ex1 = new CompStatement(new VarDeclStatement("v",
                new IntType()), new CompStatement(new AssignStatement("v",
        ...
        IStatement ex2 = new CompStatement( new VarDeclStatement("a",new IntType()),
                new CompStatement(new VarDeclStatement("b",new IntType()),
                        new CompStatement(new AssignStatement("a", new ArithmeticExpression('+',
                                new ValueExpression(new IntValue(2)),new
                                ArithmeticExpression('*',new ValueExpression(new IntValue(3)),
                                new ValueExpression(new IntValue(5))))),
                                new CompStatement(new AssignStatement("b",
                                        new ArithmeticExpression('+',new VariableExpression("a"),
                                                new ValueExpression(new
                ...
                new CompStatement(new VarDeclStatement("v", new IntType()),
                        new CompStatement(new AssignStatement("a", new ValueExpression(new BoolValue(true))),
                                new CompStatement(new IfStatement(new VariableExpression("a"),
                                        ...
                                        IntValue(2))), new AssignStatement("v",
                                        new ValueExpression(new IntValue(3)))), new PrintStatement(new
        ...
        IStatement ex5 = new CompStatement(new VarDeclStatement("number1", new IntType()),
                new CompStatement(new VarDeclStatement("number2", new IntType()),
                        new CompStatement(new AssignStatement("number1", new ValueExpression(new IntValue(2))),
                                new CompStatement(new AssignStatement("number2",
                                        new ValueExpression(new IntValue(3))),
                                        new PrintStatement(new RelationalExpression(new VariableExpression("number1"),
                                        new VariableExpression("number2"), ">"))))));

        IStatement ex6 = new CompStatement(new VarDeclStatement("v",
                new RefType(new IntType())),
                new CompStatement(new HeapAllocationStatement("v",
                        new ValueExpression(new IntValue(20))),
                new CompStatement(new VarDeclStatement("a",
                        new RefType(new RefType(new IntType()))),
                        new CompStatement(new HeapAllocationStatement("a",
                                new VariableExpression("v")),
                        new CompStatement(new PrintStatement(new VariableExpression("v")),
                                new PrintStatement(new VariableExpression("a")))))));

        IStatement ex7 = new CompStatement(new VarDeclStatement("v",
                new RefType(new IntType())),
                new CompStatement(new HeapAllocationStatement("v",
                        new ValueExpression(new IntValue(20))),
                new CompStatement(new VarDeclStatement("a",
        ...
        IStatement ex8 = new CompStatement(new VarDeclStatement("v", new RefType(new IntType())),
                new CompStatement(new HeapAllocationStatement("v",
                        new ValueExpression(new IntValue(20))),
                new CompStatement(new PrintStatement(new HeapReadingExpression(new VariableExpression("v"))),
                        new CompStatement(new HeapWritingStatement("v",
        ...
        IStatement ex10 = new CompStatement(new VarDeclStatement("v",
                new RefType(new IntType())),
                new CompStatement(new HeapAllocationStatement("v",
                        new ValueExpression(new IntValue(20))),
                new CompStatement(new VarDeclStatement("a",
        ...
        IStatement ex11 = new CompStatement(new VarDeclStatement("v",
                new RefType(new IntType())),
                new CompStatement(new HeapAllocationStatement("v",
                        new ValueExpression(new IntValue(20))),
                new CompStatement(new VarDeclStatement("a",
                        ...
                        new CompStatement(new HeapAllocationStatement("a",
                                new VariableExpression("v")),
                                new CompStatement(new VarDeclStatement("b",
                                        new RefType(new IntType())),
                                new CompStatement(new HeapAllocationStatement("b",
                                        new ValueExpression(new IntValue(1))),
        ...
        IStatement ex12 = new CompStatement(new VarDeclStatement("v",
                new IntType()), new CompStatement(new VarDeclStatement("a",
                new RefType(new IntType())), new CompStatement(new AssignStatement("v",
                new ValueExpression(new IntValue(10))),new CompStatement(new HeapAllocationStatement("a",
                new ValueExpression(new IntValue(22))),
                new CompStatement(new ForkStatement(new CompStatement(new HeapWritingStatement("a",
                        new ValueExpression(new IntValue(30))),new CompStatement(new AssignStatement("v",
        ...
        IStatement ex13 = new CompStatement(
                new VarDeclStatement("a", new RefType(new IntType())), // Ref(int) a;
                new CompStatement( new VarDeclStatement("v", new IntType()), // int v;
                        new CompStatement(new HeapAllocationStatement("a",
                                new ValueExpression(new IntValue(10))), // new(a, 10)
                                new CompStatement( new ForkStatement( // fork(...)
                                        new CompStatement(new AssignStatement("v",
                                                new ValueExpression(new IntValue(20))), // v = 20;
                                                new CompStatement(new ForkStatement( // fork(Wh(a, 40))
                                                        new HeapWritingStatement("a",
                                                                new ValueExpression(new IntValue(40)))),
                                                        new CompStatement(

                                                                new PrintStatement(new HeapReadingExpression(
                                                                        new VariableExpression("a"))), // print(rH(a));
      ...
      List<IStatement> statements = new ArrayList<>();
        ...
        for(int i = 1; i <= 13; i++){
            ...
            try {
                ...
                ProgramState programState = new ProgramState(executionStack, symbolTable, out, fileTable, heap,
                        statements.get(i - 1));
                IRepository repository = new MultiThreadRepo(programState, "log" + i + ".txt");
                Controller controller = new Controller(repository, 1);
                menu.addCommand(new RunExample("" + i, statements.get(i - 1).toString(), controller));
            }catch (ExpressionException | DataStructureExceptions | StatementException e){
